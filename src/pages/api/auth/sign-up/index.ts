...
import { handlePost } from "@/services/auth/signUp";
...
const handler = async (req: NextApiRequest, res: NextApiResponse): Promise<void> => {
  ...
  switch (req.method) {
    case REQUEST_METHODS.POST:
      ...
      try {
        const response: ApiResponse<User> = await handlePost(db, req);
      ...
      break;
    default:
      handleErrorResponse(res, 400, API_MESSAGES.GENERAL.INVALID_REQUEST_METHOD);
  }
};
